	...
	def handle_collision(self,dt):
		...
		for human in self.humans:
			...
			if (self.house.x <= self.snake.x + 10) and (self.snake.x - 10 <= self.house.x + 100) and (self.house.y <= self.snake.y + 10) and (self.snake.y - 10 <= self.house.y + 100):
				if self.snake.x + 10 >= self.house.x - 0 and not (self.snake.x + 12 >= self.house.x + 100):
					condition_label_1.text = "GAME OVER"
				...
				elif self.snake.x + 12 >= self.house.x + 100:
					condition_label_1.text = "GAME OVER"
					condition_label_2.text = "YOU HIT A HOUSE"
					condition_label_3.text = "SCORE: " + "%01d" % self.snake.points 
				...
				if self.snake.y + 10 >= self.house.y - 0 and not (self.snake.y + 12 >= self.house.y + 100):
					condition_label_1.text = "GAME OVER"
					condition_label_2.text = "YOU HIT A HOUSE"
					condition_label_3.text = "SCORE: " + "%01d" % self.snake.points 
				...
				elif self.snake.y + 12 >= self.house.y + 100:
					condition_label_1.text = "GAME OVER"
					condition_label_2.text = "YOU HIT A HOUSE"
					condition_label_3.text = "SCORE: " + "%01d" % self.snake.points 
			...
			if (human.x - 12 <= self.snake.x + 10) and (self.snake.x - 10 <= human.x + 12) and (human.y - 12 <= self.snake.y + 10) and (self.snake.y - 10 <= human.y + 12):
				if self.snake.x + 10 >= human.x - 12 and not (self.snake.x + 10 >= human.x - 12):
					human.die()
					dead = True
					self.snake.points += 1
					pointcounter.text = "%01d" % self.snake.points 
				elif self.snake.x + 10 >= human.x - 12:
					human.die()
					dead = True
					self.snake.points += 1
					pointcounter.text = "%01d" % self.snake.points 

				if self.snake.y + 10 >= human.y - 12 and not (self.snake.y + 10 >= human.y - 12):
					human.die()
					dead = True
					self.snake.points += 1
					pointcounter.text = "%01d" % self.snake.points 
				elif self.snake.y + 10 >= human.y - 12:
					human.die()
					dead = True
					self.snake.points += 1
					pointcounter.text = "%01d" % self.snake.points
